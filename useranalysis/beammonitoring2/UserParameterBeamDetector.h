...
public:
	...
	//adding time from MWPC
	TString fMWPCtimeName;
...
//	Float_t fMWPCwireStep[4];
	...
	Float_t fDistFromTarget; //for tracking using MWPCs. Positive value - shift in the same direction with z (beam axis), negative value - shift in the opposite direction to z
...
//		return stationMWPCX1name;
	...
	const TString GetStationMWPCtimename() const{
		return fBeamDetName + "_" + fMWPCtimeName;
	}
